use std::{error::Error, fs::{self, OpenOptions}, io::{self, Write}, str::FromStr, time::Duration};
...
fn run_app<B: Backend>(terminal: &mut Terminal<B>, app: &mut App) -> io::Result<bool> {
    loop {
        ...
        // Minium wait time for event so it doesn't get stuck forever while we wait for the event
